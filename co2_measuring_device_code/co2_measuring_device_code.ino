...
void loop() {
  ...
  if (co2value == 0 || temperature == 0) { //Falls der Sensor den Wert 0 ausgibt, dann soll dieser nicht berücksichtigt werden
    validValue = false;
  }
  ...
  delay(30000); //30 Sekunden warten, bevor erneut ein Wert erfasst und gesendet wird
}
